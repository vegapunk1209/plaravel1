      ...
      @endif
        <div class="contenedor-list">
            <div class="panel-heading">
                <h2 class="text-center titulo-ubicacion" style="font-weight:bold;"><i class="fa fa-list" aria-hidden="true"></i>&nbsp; Listado de Departamentos &nbsp;<i class="fa fa-list" aria-hidden="true"></i></h2>
            </div>
                        ...
                        <table class="table table-hover" id="tbl-monedas">
						  <thead>
						     <tr>
						      ...
						      <th class="text-center" style="vertical-align:middle;" data-column-id="nombre_estado">Nombre de Zona</th>
						    </tr>
						  </thead>
						  <tbody>
